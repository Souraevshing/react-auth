...
const reservations = [
  {
    id: '12345',
    restaurantId: '123',
    userId: 'yd9wTqw3WbMa5kpSikuRnnRmSIk2',
...
const reviews = [
  {
    ...
    photoUrls: [
      'https://storage.googleapis.com/restaurant-app-c293e.appspot.com/reviewPhotos/hemingways-review-1.jpeg',
    ],
    text: `
...
const restaurants = [
  {
    ...
    name: "Hemingway's",
    imageUrl:
      'https://storage.googleapis.com/restaurant-app-c293e.appspot.com/restaurants/hemingways.jpeg',
    rating: 4.0,
    address: {
  ...
  },
  {
    ...
    name: "Ben's Burgers",
    imageUrl:
      'https://storage.googleapis.com/restaurant-app-c293e.appspot.com/restaurants/bens-burgers.jpeg',
    rating: 3.5,
    address: {
  ...
  },
  {
    ...
    name: 'Le Mollusc',
    imageUrl:
      'https://storage.googleapis.com/restaurant-app-c293e.appspot.com/restaurants/le-mollusc.jpeg',
    rating: 4.5,
    address: {
